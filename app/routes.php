...
Route::get('listeCours',array('uses'=>'CourseController@lister'));



Route::get('course/{course}',array('uses'=>'CourseController@afficher'));

Route::get('session/{session}',array('uses'=>'CourseSessionController@afficher'));

Route::get('student/{student}',array('uses'=>'StudentController@afficher'));

Route::get('teacher/{teacher}',array('uses'=>'TeacherController@afficher'));

Route::get('accueil',function(){
    return View::make('accueil')->with(array('titre'=>'Tableau de bord'));
});
